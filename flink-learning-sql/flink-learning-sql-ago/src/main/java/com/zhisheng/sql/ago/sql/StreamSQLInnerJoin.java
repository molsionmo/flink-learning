...
public class StreamSQLInnerJoin {
    public static void main(String[] args) throws Exception {
        ...
        Table result = tEnv.sqlQuery("select o.*,p.productName from OrderA o inner join Product p on o.productId = p.productId");

        tEnv.toAppendStream(result, OrderProduct.class).print();
